...
# face_analysis model
python scripts/onnx2trt.py -o ./checkpoints/liveportrait_onnx/retinaface_det.onnx
python scripts/onnx2trt.py -o ./checkpoints/liveportrait_onnx/face_2dpose_106.onnx
